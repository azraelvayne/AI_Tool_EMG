      ...
      <div className="max-w-7xl mx-auto px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <div>
          <div className="flex items-center justify-between gap-4 mb-8">
            ...
            <button
              onClick={onBrowseAllInspirations}
              className="hidden md:inline-flex items-center gap-2 px-5 py-2.5 bg-white border-2 border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition-all duration-300 font-medium"
            >
              <span>{language === 'zh-TW' ? '查看全部' : 'View All'}</span>
