...
export function LearnPage({ language, onBackToHome }: LearnPageProps) {
  ...
  return (
    <PageTransition className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-cyan-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-gradient-to-r from-sky-50 to-cyan-50 rounded-xl border border-sky-200 p-8 text-center">
